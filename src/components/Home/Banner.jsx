            ...
            <FadeIn y={0} x={-50} duration={2} delay={0.2}>
              <div>
                ...
                <p className="text-[#a1a3af] text-lg mt-5 md:mt-8">
                  I'm a passionate full-stack web developer with a focus on
                  backend development using Python and Django also ReactJs for
                  Front-end. With a strong foundation in design principles and a
                  love for clean code, I craft intuitive, responsive, and
                  user-friendly digital experiences using ReactJS and modern web
                  tools.
                </p>
